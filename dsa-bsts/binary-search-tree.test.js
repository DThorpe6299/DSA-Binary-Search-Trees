...
describe("insert", function() {
  console.log("At the insert method")
  it("inserts a node at the correct position", function() {
    console.log("Inside the insert method")
    var binarySearchTree = new BinarySearchTree();
    console.log("Here is the BST:", binarySearchTree );
    binarySearchTree
      .insert(15)
      .insert(20)
      .insert(10)
      .insert(12);
      console.log("Here is the BST after inserts:", binarySearchTree );
...
describe("insertRecursively", function() {
  console.log("Now in the insertRecursively method")
  it("inserts a node at the correct position", function() {
    console.log("Inside the recursive insert")
    var binarySearchTree = new BinarySearchTree();
    binarySearchTree
      ...
      console.log("The BST after recursive insert:", binarySearchTree)
    expect(binarySearchTree.root.val).toEqual(15);
    expect(binarySearchTree.root.right.val).toEqual(20);
    expect(binarySearchTree.root.left.right.val).toEqual(12);
  });
  ...
  it("inserts a node at the root if there is nothing there", function() {
    console.log("Inside the recursive insert but null tree")
    var binarySearchTree = new BinarySearchTree();
...
describe("find", function() {
  console.log("Starting the find method")
  it("finds a node correctly", function() {
    ...
    binarySearchTree
      ...
      .insert(10)
      .insert(12);
    console.log("BST after insertions for find", binarySearchTree)
  ...
  it("returns undefined if a node is not found", function() {
    console.log("In the find method but node not found")
    let binarySearchTree = new BinarySearchTree();
    binarySearchTree
      .insert(15)
      .insert(20)
      .insert(10)
      .insert(12);
      console.log("The BST after inserts for node not found", binarySearchTree)
    var foundNode = binarySearchTree.find(120);
    console.log("Node in question:", foundNode)
    expect(foundNode).toBe(undefined);
  });
});

describe("findRecursively", function() {
  console.log("Starting the recursive find method")
  it("finds a node correctly", function() {
    console.log("Performing the recursive find method")
    let binarySearchTree = new BinarySearchTree();
    binarySearchTree
      .insert(15)
      .insert(20)
